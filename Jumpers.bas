...
'---------------------------clear cells BAT-FCF -QAB -BGT -QCE -BCT- BCN- BAD- EB- EA- BGB----------------------------------
...
Set MyPlage = Range("A15:A1000")
    ...
    End If
    End If
                If cell.Value <> cell(1, 4).Value And cell(1, 9).Value = "Direct connection" Then
            x = InputBox("Please add cross-section of conductors between" & vbNewLine & cell(1, 3) & " and " & cell(1, 6), "Wire jumper  between " & cell(1, 3) & " and " & cell(1, 6), wire)
            cell(1, 9).Value = "Conductor / wire"
            cell(1, 9).Font.ColorIndex = 3
            cell(1, 9).Font.Bold = True
...
Set MyPlage = Range("A15:A1000")
   ...
   If Left(cell.Value, 3) = "XDC" And cell.Value = cell(1, 4).Value Then
        ...
        If IsEmpty(cell(1, 7).Value) And Left(cell.Value, 3) = "XDC" And (cell(1, 9).Value = "Wire jumper") Then
...
Set MyPlage = Range("A15:A1000")
    ...
    For Each cell In MyPlage
        ...
        End If
                         ...
                         If IsEmpty(cell(1, 7).Value) And Left(cell.Value, 3) = "XDI" And (cell(1, 9).Value = "Wire jumper") Then
...
Set MyPlage = Range("A15:A1000")
   ...
   If Left(cell.Value, 3) = "XDX" And cell.Value = cell(1, 4).Value Then
        ...
        End If
                ...
                If IsEmpty(cell(1, 7).Value) And Left(cell.Value, 3) = "XDX" And (cell(1, 9).Value = "Wire jumper") Then
  ...
  '---------------------------Wire Bridges----------------------------------------------
   ...
   If cell.Value = "XDB1" And cell.Value = cell(1, 4).Value Then
        ...
        End If
          ...
          If IsEmpty(cell(1, 7).Value) And cell.Value = "XDB1" And (cell(1, 9).Value = "Wire jumper") Then
   ...
   If cell.Value = "XDE" And cell.Value = cell(1, 4).Value Then
        ...
        End If
                    ...
                    If IsEmpty(cell(1, 7).Value) And Left(cell.Value, 3) = "XDE" And (cell(1, 9).Value = "Wire jumper") Then
   ...
   If cell.Value = "XDT" And cell.Value = cell(1, 4).Value Then
        ...
        End If
        End If
                  If IsEmpty(cell(1, 7).Value) And Left(cell.Value, 3) = "XDT" And (cell(1, 9).Value = "Wire jumper") Then
