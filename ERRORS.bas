...
If Error_menu.ABB.Value = True And Error_menu.PHOENIX.Value = False Then
     
            If cell.Value = "XDV" And cell.Value = cell(1, 4).Value Then   ' За порверка на всички връзки трябва да си изтрие  And (cell(1, 9).Value = "Wire jumper" Or cell(1, 9).Value = "Conductor / wire")
...
End If
            If cell.Value = "XDV" And cell.Value = cell(1, 4).Value And (cell(1, 9).Value = "Saddle jumper" Or cell(1, 9).Value = "Insertable jumper") Then
            cell(1, 7).ClearContents
            cell(1, 8).ClearContents
            If cell(1, 9).Value = "Saddle jumper" Then ' клеми Phoenix за ABB обратно Saddle jumper
            cell(1, 9).Value = "Insertable jumper"
            cell(1, 9).Font.ColorIndex = 6
            cell(1, 9).Font.Bold = True
            End If
...
End If
 '-------------Jumpers---PHOEXIX-------------------------------
 If Error_menu.ABB.Value = False And Error_menu.PHOENIX.Value = True Then

            If cell.Value = "XDV" And cell.Value = cell(1, 4).Value Then
            cell(1, 7).ClearContents
            cell(1, 8).ClearContents
            If cell(1, 9).Value = "Insertable jumper" Then ' клеми Phoenix за ABB обратно Saddle jumper
            cell(1, 9).Value = "Saddle jumper"
            cell(1, 9).Font.ColorIndex = 6
            cell(1, 9).Font.Bold = True
            End If
             If Not (cell(1, 9).Value = "Saddle jumper" Or cell(1, 9).Value = "Insertable jumper") Then
             cell(1, 9).Value = "Saddle jumper"
            cell(1, 9).Font.ColorIndex = 3
            cell(1, 9).Font.Bold = True
            End If
...
For Each cell In MyPlage
If Error_menu.ABB.Value = True And Error_menu.PHOENIX.Value = False Then
If cell.Value = "XDA" And cell.Value = cell(1, 4).Value Then ' За порверка на всички връзки трябва да си изтрие  And (cell(1, 9).Value = "Wire jumper" Or cell(1, 9).Value = "Conductor / wire")
            answer = MsgBox("Is connection between" & cell(1, 3).Value & " And " & cell(1, 6).Value & " is with-" & cell(1, 9).Value, vbYesNo + vbQuestion, "-XDV jumpers")
            If answer = vbYes Then
            If (cell(1, 9).Value = "Saddle jumper" Or cell(1, 9).Value = "Insertable jumper") Then
            cell(1, 7).ClearContents
...
End If
    ...
    If cell.Value = "XDA" And cell.Value = cell(1, 4).Value And (cell(1, 9).Value = "Saddle jumper" Or cell(1, 9).Value = "Insertable jumper") Then
            cell(1, 7).ClearContents
            cell(1, 8).ClearContents
            If cell(1, 9).Value = "Saddle jumper" Then ' клеми Phoenix за ABB обратно Saddle jumper
            cell(1, 9).Value = "Insertable jumper"
...
If cell.Value = "XDI7" And Not (cell(1, 9).Value = "Saddle jumper" Or cell(1, 9).Value = "Insertable jumper") And cell(1, 12).Value <> "Shielded cable" Then
...
'---------------------------XDB1 connector---------------------------------------------
'---------------------------------------------------------------------------------------------
If Error_menu.CheckBox2.Value = True And Error_menu.CheckBox1.Value = False And Error_menu.motor.Value Then
...
If Error_menu.CheckBox2.Value = False And Error_menu.CheckBox1.Value = True And Error_menu.motor.Value Then
